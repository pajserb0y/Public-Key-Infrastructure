...
//        try {
            ...
            writer.loadKeyStore(KEYSTORE_JKS_FILE_NAME, jksPass.toCharArray());
            writer.write(certificateDataDTO.getIssuerAlias(), keyPairIssuer.getPrivate(), certificateDataDTO.getJksPass().toCharArray(), cert);
            writer.saveKeyStore(KEYSTORE_JKS_FILE_NAME, jksPass.toCharArray());

            //Database
            if (certificateDataDTO.getIssuerAlias().equals(certificateDataDTO.getSubjectAlias()))
                certificateRepository.save(new Certificate(null, subjectData.getSerialNumber(), certificateDataDTO.getCn(), certificateDataDTO.getOn(), certificateDataDTO.getOu(),
                        ...
                        certificateDataDTO.getSubjectAlias(), certificateDataDTO.getStartDate(), certificateDataDTO.getEndDate(), certificateDataDTO.getJksPass(), null));
            else
                certificateRepository.save(new Certificate(null, subjectData.getSerialNumber(), certificateDataDTO.getCn(), certificateDataDTO.getOn(), certificateDataDTO.getOu(),
                        certificateDataDTO.getSurname(), certificateDataDTO.getGivenName(), certificateDataDTO.getO(), certificateDataDTO.getC(), certificateDataDTO.getE(),
                        certificateDataDTO.getSubjectAlias(), certificateDataDTO.getStartDate(), certificateDataDTO.getEndDate(), certificateDataDTO.getJksPass(),
